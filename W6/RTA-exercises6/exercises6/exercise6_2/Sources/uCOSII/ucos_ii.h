...
typedef struct os_tcb {
...
#if OS_RELTEQ_EN > 0
    INT16U           OSTCBPeriod;			      /* Period in ticks                                         */
    INT16U           OSTCBOffset;			      /* Offset in ticks                                         */
    OS_EVENT        *OSTCBPeriodEvent;		  /* Period event semaphore                                  */
    struct RelteqEvent*     OSTCBPeriodRelteqEvent;
    struct RelteqEvent*     OSTCBReadyQueueEvent;
#if OS_RELTEQ_SPORADIC_TASK_EN > 0               /* Support for sporadic tasks                              */
    INT8U            OSTCBSporadicFlag;     /* Store if the periodic task and the event have arrived   */
#endif
#if OS_RELTEQ_HSF_EN > 0    
    struct RelteqServer*    OSTCBServer;
#endif
#endif /* OS_RELTEQ_EN */
    ...
    INT8U            OSTCBThreshold;        /* Task preemption threshold, e.g. Regehr and/or SRP       */
#endif
...
void         OSTaskThresholdSet      (INT8U            prio,
                                      INT8U            threshold);
...
#ifndef OS_MUTEX_SRP_EN
    #error  "OS_CFG.H, Missing OS_MUTEX_SRP_EN: Identifier for the SRP protocol"
#endif
...
/************************************************************************************************************************
*                           SRP and 2-level SRP-based protocols
************************************************************************************************************************
*/
#if OS_MUTEX_SRP_EN > 0
#include "os_srp.h"
