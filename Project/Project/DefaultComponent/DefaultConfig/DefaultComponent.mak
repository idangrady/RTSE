...
TPMS.obj : TPMS.cpp TPMS.h    Default.h Engine.h Battery.h GPS.h 
	$(CREATE_OBJ_DIR)
...
GPS.obj : GPS.cpp GPS.h    Default.h TPMS.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"GPS.obj" "GPS.cpp" 



Default.obj : Default.cpp Default.h    TPMS.h Engine.h Battery.h GPS.h 
	$(CREATE_OBJ_DIR)
