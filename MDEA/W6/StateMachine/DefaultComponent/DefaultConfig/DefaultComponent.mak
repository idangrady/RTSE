...
PowerSouceCar.obj : PowerSouceCar.cpp PowerSouceCar.h    Default.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"PowerSouceCar.obj" "PowerSouceCar.cpp" 



Default.obj : Default.cpp Default.h    PowerSouceCar.h 
	$(CREATE_OBJ_DIR)
...
clean:
	@echo Cleanup
	if exist PowerSouceCar.obj erase PowerSouceCar.obj
