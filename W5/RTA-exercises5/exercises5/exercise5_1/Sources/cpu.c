...
void CPUInitRTI(void){
  /* IMPORTANT: remember to update OS_TICKS_PER_SEC in os_cfg.h! */
  //RTICTL = 0xE3;        /* RTI Decimal divider = 400x10^3; RTI period = 4MHz/400k = 10Hz */
  //RTICTL = 0xC3;        /* RTI Decimal divider = 80x10^3; RTI period = 4MHz/80k = 50Hz */
  //RTICTL = 0xB3;        /* RTI Decimal divider = 40x10^3; RTI period = 4MHz/40k = 100Hz */
  //RTICTL = 0x93;        /* RTI Decimal divider = 4x10^3; RTI period = 4MHz/8k = 500Hz */
  //RTICTL = 0x83;        /* RTI Decimal divider = 4x10^3; RTI period = 4MHz/4k = 1kHz NOT WORKING IN SIMULATOR */
  //RTICTL = 0x91;        /* RTI Decimal divider = 4x10^3; RTI period = 4MHz/4k = 1kHz */
